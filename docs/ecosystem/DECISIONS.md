...
|----|----------|--------------------|------------|------|--------|
| DD-01 | Toolchain | TS validation + Python queries / All-TS / All-Python | **Open** | 2026-02-22 | |
...
| DD-04 | Journey stage labels | Confirm J0-J8 before locking registry | **Open** — proposed in Spec v0.2 section 2 | 2026-02-22 | |
